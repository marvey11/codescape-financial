...
export const BuyOperationCard = ({
  ...
  const totalAmount = numberOfShares * pricePerShare + fees;

  return (
    <div className="rounded-lg border border-green-200 bg-green-50 p-4 shadow-md">
      {/* Added border */}
      <h3 className="text-lg font-bold uppercase text-green-700">Buy</h3>
      ...
      <div className="grid grid-cols-2 gap-x-4 text-sm">
        ...
        <p className="col-span-2 mt-1 text-base font-bold text-green-800">
          {/* Span two columns */}
